    ...
    return (
        <div>
            ...
            <input
                ...
                className="mt-1 block w-full text-sm text-gray-700 dark:text-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 dark:file:bg-blue-900/50 file:text-blue-700 dark:file:text-blue-300 hover:file:bg-blue-100 dark:hover:file:bg-blue-900"
            />
            {isUploading && <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Uploading...</p>}
                    ...
                    {images.map((url, idx) => (
                        <div key={idx} className="relative">
                            <img
                                src={url}
                                alt={`preview-${idx}`}
                                className="h-24 w-full object-cover rounded-md border dark:border-gray-600"
                            />
                            <button
                                type="button"
