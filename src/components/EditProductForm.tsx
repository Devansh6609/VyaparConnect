...
export default function EditProductForm({
    ...
    const [workflow, setWorkflow] = useState<WorkflowType>(product.workflow || 'HYBRID');
    ...
    return (
        <form
            ...
            className="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg p-4 shadow-md"
        >
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Edit Product</h3>
