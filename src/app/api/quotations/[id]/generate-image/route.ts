...
// FIX: Import 'Buffer' explicitly to resolve type errors.
...
export async function GET(_: Request, { params }: { params: { id: string } }) {
  try {
    ...
    const buffer = (await nodeHtmlToImage({
      html,
      // FIX: The 'encoding' option with value 'buffer' is invalid for node-html-to-image. The library returns a buffer by default when the 'output' option is omitted.
