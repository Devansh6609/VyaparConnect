...
const QuotationsPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            setLoading(true);
            try {
                // This endpoint still exists and returns quotation summaries
    ...
    return (
        <div className="p-6 md:p-8 bg-gray-50/50 dark:bg-transparent min-h-full">
            ...
            >
                <div>
                    <h1 className="text-3xl font-bold text-gray-800">Quotation Tracker</h1>
                    <p className="text-gray-500 mt-1">Monitor all your quotations and their statuses.</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <AnimatePresence>
                        {filteredTransactions.length > 0 ? (
                            ...
                            <motion.div layout initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center py-16 bg-white rounded-lg border">
                                ...
                                <h3 className="mt-2 text-lg font-medium text-gray-700">No Quotations Found</h3>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
                        ...
                        <p className="text-sm font-medium text-gray-600 mt-1">Active Quotations</p>
                    </div>
                </div>
            </div>
